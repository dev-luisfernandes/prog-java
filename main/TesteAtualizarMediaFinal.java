...
public class TesteAtualizarMediaFinal {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        objMediaFinal.setRm(inteiro("Informe o RM do aluno (a) a ser atualizado (a)"));
        objMediaFinal.setNome(texto("Nome do aluno (a) a ser atualizado (a)"));
        objMediaFinal.setTurma(texto("Turma a ser atualizada"));
        ...
        System.out.println(dao.atualizar(objMediaFinal));
    }
}
